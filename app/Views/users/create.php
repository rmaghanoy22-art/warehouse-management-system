...
<div class="max-w-lg mx-auto">
    ...
    <div class="card">
        <div class="card-header bg-gradient-to-r from-gray-50 to-white"><h3 class="text-lg font-bold">Add New User</h3></div>
        <div class="card-body">
            <form action="/users/store" method="POST" class="space-y-5">
                <?= csrf_field() ?>
                <div><label class="form-label">Username *</label><input type="text" name="username" value="<?= old('username') ?>" class="form-input" required></div>
                ...
                <div>
                    ...
                    <div class="password-wrapper relative">
                        <input type="password" id="create_user_password" name="password" class="form-input pr-11" required minlength="8" placeholder="Minimum 8 characters">
                ...
                <div class="flex gap-3"><button type="submit" class="btn-primary">Create User</button><a href="/users" class="btn-secondary">Cancel</a></div>
            </form>
        </div>
    </div>
</div>
