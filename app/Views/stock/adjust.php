...
<div class="max-w-lg mx-auto">
    <div class="mb-6"><a href="/stock/logs" class="inline-flex items-center gap-1 text-sm text-primary-600 hover:text-primary-700 font-medium transition-colors"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>Back to Stock Logs</a></div>
    <div class="card">
        <div class="card-header bg-gradient-to-r from-gray-50 to-white"><h3 class="text-lg font-bold">Manual Stock Adjustment</h3></div>
        <div class="card-body">
            <form action="/stock/adjust" method="POST" class="space-y-5">
                <?= csrf_field() ?>
                <div>
                    ...
                    @click.outside="open = false">
                        ...
                        <button type="button" 
                            ...
                            <span x-text="selectedLabel" class="truncate text-sm text-gray-700">Select product</span>
                        </button>
                                    ...
                                    <button type="button" 
                                        ...
                                        <div class="flex flex-col gap-0.5 min-w-0 text-left">
                                            ...
                                            <div class="text-xs text-gray-700 mt-0.5">
                                                ...
                                                <span class="text-gray-400 text-[10px] ml-1" x-text="'(Current: ' + opt.stock + ')'"></span>
                                            </div>
                                        </div>
                ...
                <div><label class="form-label">New Quantity *</label><input type="number" name="new_quantity" class="form-input" min="0" required></div>
                <div><label class="form-label">Reason / Notes *</label><textarea name="notes" class="form-input" rows="3" required placeholder="Explain the adjustment reason..."></textarea></div>
                <div class="flex gap-3"><button type="submit" class="btn-primary">Adjust Stock</button><a href="/stock/logs" class="btn-secondary">Cancel</a></div>
            </form>
        </div>
    </div>
</div>
